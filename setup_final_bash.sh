...
generate_xray_config_vm() {
    ...
    cat <<EOF > /usr/local/etc/xray/config.json
{"log":{"loglevel":"warning"},"inbounds":[{"listen":"127.0.0.1","port":12345,"protocol":"dokodemo-door","settings":{"network":"tcp,udp","followRedirect":true},"sniffing":{"enabled":true,"destOverride":["http","tls"]},"tag":"tproxy-in"},{"listen":"127.0.0.1","port":53,"protocol":"dokodemo-door","settings":{"address":"1.1.1.1","network":"tcp,udp","port":53},"tag":"dns-in"}],"outbounds":[{"protocol":"vless","tag":"vless-reality","settings":{"vnext":[{"address":"$VLESS_HOST","port":$VLESS_PORT,"users":[{"id":"$VLESS_ID","flow":"$VLESS_FLOW","encryption":"none"}]}]},"streamSettings":{"network":"tcp","security":"reality","realitySettings":{"fingerprint":"$VLESS_FP","serverName":"$VLESS_SNI","publicKey":"$VLESS_PBK","shortId":"$VLESS_SID","spiderX":"$VLESS_SPX"}}},{"protocol":"freedom","tag":"direct"},{"protocol":"blackhole","tag":"block"},{"protocol":"dns","tag":"dns-out"}],"routing":{"rules":[{"type":"field","inboundTag":["dns-in"],"outboundTag":"direct"},{"inboundTag":["tproxy-in"],"outboundTag":"block","type":"field","network":"udp","port":"135, 137, 138, 139"},{"inboundTag":["tproxy-in"],"outboundTag":"block","type":"field","domain":["appcenter.ms"]},{"inboundTag":["tproxy-in"],"outboundTag":"direct","type":"field","network":"udp","port":"4004","ip":["94.79.52.202"]},{"inboundTag":["tproxy-in"],"outboundTag":"direct","type":"field","domain":["vpn.iac.mchs.ru","regexp:^([a-zA-Z0-9_.-]+\\\\.)ru$","regexp:^([a-zA-Z0-9_.-]+\\\\.)su$","regexp:^([a-zA-Z0-9_.-]+\\\\.)xn--p1ai$","regexp:^([a-zA-Z0-9_.-]+\\\\.)xn--p1acf$","regexp:^([a-zA-Z0-9_.-]+\\\\.)xn--80asehdb$","regexp:^([a-zA-Z0-9_.-]+\\\\.)xn--c1avg$","regexp:^([a-zA-Z0-9_.-]+\\\\.)xn--80aswg$","regexp:^([a-zA-Z0-9_.-]+\\\\.)xn--80adxhks$","regexp:^([a-zA-Z0-9_.-]+\\\\.)moscow$","regexp:^([a-zA-Z0-9_.-]+\\\\.)xn--d1acj3b$"]},{"inboundTag":["tproxy-in"],"outboundTag":"direct","type":"field","protocol":["bittorrent"]},{"inboundTag":["tproxy-in"],"outboundTag":"vless-reality","type":"field"}]},"dns":{"servers":["https://1.1.1.1/dns-query","8.8.8.8"]}}
